	 ...
	 <center>
        ...
        <form method="post" action="/rentACar/uploadServlet" enctype="multipart/form-data">
            <table border="0">
                ...
                <tr>
                    <td colspan="2">
                        <input class="btn btn-success active " type="submit" value="Save">
                    </td>
                </tr>
            </table>
        </form>
        <a href="/rentACar/admin/pregledFotografija.jsp"><button class="btn btn-success active">Pregled fotografija</button></a>
    </center>
